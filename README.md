About pyproprop-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyproprop-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10586&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyproprop-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyproprop` can be installed with `conda`:
...
```
mamba install pyproprop
```

It is possible to list all of the versions of `pyproprop` available on your platform with `conda`:
...
```
mamba search pyproprop --channel conda-forge
```
...
mamba repoquery search pyproprop --channel conda-forge

# List packages depending on `pyproprop`:
mamba repoquery whoneeds pyproprop --channel conda-forge

# List dependencies of `pyproprop`:
mamba repoquery depends pyproprop --channel conda-forge
```
